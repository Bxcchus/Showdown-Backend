...
class SecurityConfiguration {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .permitAll()
                        .requestMatchers("/api/v2/realtime/matches")
                        .permitAll()
                        .requestMatchers("/api/v2/watchers/duels/**")
                        .hasAuthority("SCOPE_service:duel:observe")
                        .requestMatchers("/api/v2/watchers/matches/**")
    ...
    JwtDecoder jwtDecoder(
        ...
        decoder.setJwtValidator(tokenValidator(issuer, requiredAudience));
        return decoder;
    }

    static OAuth2TokenValidator<Jwt> tokenValidator(String issuer, String requiredAudience) {
